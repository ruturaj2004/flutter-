// import 'package:firstpage/practice/bottomsheet.dart';
  ...
  _resetpassword() {
    return Row(
      children: [
        Checkbox(
          ...
          fillColor:
            ...
            return const Color.fromARGB(
                255, 245, 241, 240); // or the color you want when not selected
          }),
          value: isChecked,
        ...
        Column(
          children: [Text("Remender Me !", style: TextStyle(fontSize: 16))],
        ),
        Padding(

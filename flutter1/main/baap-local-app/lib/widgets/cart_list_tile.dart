                  ...
                  children: [
                    ...
                    QuantityWidget(
                      ...
                      onDecrementQuantity: (value) {
                        ...
                        state.data?.data?.products?[widget.index].quantity =
                            value;
                        log('state.data?.data?.products ${state.data?.data?.products?[widget.index].productcode?.productcode} ${state.data?.data?.products?[widget.index].quantity}');
                        log("${widget.cartId}ddddd");
                        log("${LocalStorageUtils.tokenResponseModel.userId}");
                         context.read<CartCubit>().updateCartProductById(
                          widget.groupId,
                          state.data?.data?.products?[widget.index]
                                  .productcode?.productcode,                                  

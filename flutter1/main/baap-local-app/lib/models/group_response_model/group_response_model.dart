...
class GroupModel {
  ...
  factory GroupModel.fromJson(Map<String, dynamic> json) => GroupModel(
        ...
        administrators: json["administrators"] == null
            ? []
            : List<dynamic>.from(json["administrators"]!.map((x) => x)),
        commonSettings: json["commonSettings"] == null
            ? null
            : CommonSettings.fromJson(json["commonSettings"]),
        themingOptions: json["themingOptions"] == null
            ? null
            : ThemingOptions.fromJson(json["themingOptions"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "administrators": administrators == null
            ? []
            : List<dynamic>.from(administrators!.map((x) => x)),
...
class Account {
  ...
  factory Account.fromJson(Map<String, dynamic> json) => Account(
        ...
        id: json["_id"],
        bankDetiles: json["bankDetiles"] == null
            ? null
            : BankDetiles.fromJson(json["bankDetiles"]),
      );

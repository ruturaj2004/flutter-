...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        coverImages: json["coverImages"] == null ? [] : List<dynamic>.from(json["coverImages"]!.map((x) => x)),
    );
...
class CommonSettings {
    ...
    factory CommonSettings.fromJson(Map<String, dynamic> json) => CommonSettings(
        ...
        isPaymentSettings: json["isPaymentSettings"],
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "timeZone": timeZone,
        "isPaymentSettings": isPaymentSettings,
    };
}
